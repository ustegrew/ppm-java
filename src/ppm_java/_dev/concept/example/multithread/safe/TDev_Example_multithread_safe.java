...
package ppm_java._dev.concept.example.multithread.safe;

/**
 * @author Peter Hoppe
 *
 */
public class TDev_Example_multithread_safe
{
    public static void main (String[] args)
    {
        TDev_Example_multithread_safe             unsafeClient;
        
        unsafeClient = new TDev_Example_multithread_safe ();
        unsafeClient.start ();
    }
     ...
     * 
     */
    public TDev_Example_multithread_safe ()
    {
